              ...
              <div className="xl:col-span-4 space-y-5">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-2">
                      <div><label className="block text-sm font-bold text-blue-700 mb-1">אורך קיר ראשי (ס&quot;מ)</label><input type="number" value={lengthWall} onChange={(e) => { setLengthWall(e.target.value); saveCurrentState(); }} placeholder="" className="w-full border rounded-lg p-2 text-center font-bold text-lg" /></div>
                      <div><label className="block text-sm font-bold text-blue-700 mb-1">יציאה (ס&quot;מ)</label><input type="number" value={exitWidth} onChange={(e) => { setExitWidth(e.target.value); saveCurrentState(); }} placeholder="" className="w-full border rounded-lg p-2 text-center font-bold text-lg" /></div>
                    </div>
                    <div className="p-3 bg-orange-50 rounded-xl border border-orange-200">
                      ...
                      {isLShape && (
                        <div className="grid grid-cols-2 gap-2 mt-2">
                          <div><label className="block text-xs text-orange-700 mb-1">רוחב הבליטה</label><input type="number" value={lWallWidth} onChange={(e) => { setLWallWidth(e.target.value); saveCurrentState(); }} className="w-full border border-orange-300 rounded-lg p-2" /></div>
                          <div><label className="block text-xs text-orange-700 mb-1">עומק הבליטה</label><input type="number" value={lWallDepth} onChange={(e) => { setLWallDepth(e.target.value); saveCurrentState(); }} className="w-full border border-orange-300 rounded-lg p-2" /></div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 bg-slate-50">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                    ...
                    <div><label className="block text-xs font-semibold text-slate-600 mb-1">גבהי עמודים (מופרד בפסיק)</label><input type="text" value={postHeight} onChange={(e) => { setPostHeight(e.target.value); saveCurrentState(); }} placeholder="250, 260" className="w-full border rounded-lg p-2" /></div>
              ...
              <div className="lg:col-span-4 space-y-5">
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-blue-200 bg-blue-50">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2"><div><label className="block text-sm font-semibold text-slate-600 mb-1">טלפון</label><input type="text" value={fenceCustPhone} onChange={(e) => setFenceCustPhone(e.target.value)} className="w-full border rounded-lg p-2.5 bg-white" /></div><div><label className="block text-sm font-semibold text-slate-600 mb-1">כתובת</label><input type="text" value={fenceCustAddress} onChange={(e) => setFenceCustAddress(e.target.value)} className="w-full border rounded-lg p-2.5 bg-white" /></div></div>
                  </div>
                </div>
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">{fenceSegments.map((seg) => (
                    <div key={seg.id} className="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-sm relative flex flex-col gap-4">
                      ...
                      <div><label className="block text-sm font-bold text-slate-600 mb-1">אורך כולל (ס&quot;מ)</label><input type="number" value={seg.L || ""} onChange={(e) => updateFenceSeg(seg.id, "L", parseFloat(e.target.value) || 0)} className="w-full text-center font-black text-2xl p-3 border border-slate-300 rounded-xl" placeholder="0" /></div>
                      <div><label className="block text-sm font-bold text-slate-600 mb-1">גובה (ס&quot;מ)</label><input type="number" value={seg.H || ""} onChange={(e) => updateFenceSeg(seg.id, "H", parseFloat(e.target.value) || 0)} className="w-full text-center font-black text-2xl p-3 border border-slate-300 rounded-xl" placeholder="0" /></div>
